...
func (o Options) transform() bool {
	return o.Color != "" || o.Width != 0 || o.Height != 0 || o.Rotate != 0 || o.FlipHorizontal || o.FlipVertical || o.Quality != 0 || o.Format != "" || o.CropX != 0 || o.CropY != 0 || o.CropWidth != 0 || o.CropHeight != 0
}
...
func ParseOptions(str string) Options {
	...
	for _, opt := range strings.Split(str, ",") {
		...
		case strings.HasPrefix(opt, optColor):
			color := opt[3:]
			options.Color = color
